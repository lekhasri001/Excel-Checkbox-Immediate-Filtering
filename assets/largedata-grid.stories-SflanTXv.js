import{j as e}from"./index-DlC1yEB1.js";import{r as i}from"./index-D5jfS-9e.js";import{C as r,a as o,m as oe,b as ie,D as G,P as le,G as se,e as de,W as ue,S as ce,c as K,d as pe,f as me,g as X,h as t,T as F,Q as he,U as ge,i as fe,j as we}from"./data-BTtIYNr_.js";import"./index-lf5wH9A6.js";const ye=[40,80,120,200],S=a=>{var D,R,E,T,A;const{enableRtl:f,enableRipple:$,localDataCount:l,isTextWrapData:C,isDialogInsideGrid:b,isStrictMode:Y,isMultipleChildren:Z,parentContainerHeight:ee="93vh",...n}=a;((E=(R=n.columns)==null?void 0:R[((D=n.columns)==null?void 0:D.length)-1])==null?void 0:E.headerText)==="Command Actions"&&(n.columns[((T=n.columns)==null?void 0:T.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const x=i.useRef(null),w=i.useRef(null),[y,ne]=i.useState(!0),[v,te]=i.useState(!1),ae=i.useMemo(()=>C?oe(l):ie(l,n.columns),[l,(A=n.columns)==null?void 0:A.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>te(!v),children:[v?"Destroy":"Render"," Data Grid"]}),l&&!C&&e.jsxs("button",{onClick:()=>ne(!y),children:[y?"Uniform":"Non Uniform"," Row Height Applied"]}),v&&e.jsx(le,{dir:f?"rtl":"ltr",ripple:$,locale:n.locale,children:e.jsx(se,{ref:x,dataSource:l?ae:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:y?null:re=>ye[re.rowIndex%4],children:Z?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(x)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:w,style:{height:ee,isolation:"isolate"},children:Y?e.jsx(i.StrictMode,{children:b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()}):b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()})};try{S.displayName="LargeDataGridTest",S.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
